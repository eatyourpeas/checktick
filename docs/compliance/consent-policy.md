---
title: "Lawful Basis & Consent Statement"
...
{{ platform_name }} is primarily a **Data Processor** for patient-related health data. We process this data strictly on the instructions of our customers (Healthcare Providers).
...
While the Data Controller (the healthcare org) chooses the legal basis for their survey, {{ platform_name }} provides the following technical safeguards:
