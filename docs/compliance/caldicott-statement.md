---
title: "Caldicott Guardian Statement: CheckTick"
...
This statement outlines how {{ platform_name }}, as a provider of healthcare survey services, adheres to the Caldicott Principles to protect the confidentiality of patient and service user information.

## 2. Commitment to the 8 Caldicott Principles

{{ platform_name }} operates in full alignment with the 8 Caldicott Principles (National Data Guardian, 2020) to ensure that health and social care data is handled with the highest level of integrity.

| Principle | Implementation at {{ platform_name }} |
| :--- | :--- |
