...
The average clinician in the NHS has plenty of research ideas, quality improvement or audit project opportunities, but most will not have any departmental money to spend on carrying them out. If any of these involve running a survey that includes patients the only platforms that can host them sit within Universities and are out of reach of the average person running a small project in their spare time.
