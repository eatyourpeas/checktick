...
The [NHS Data Dictionary](https://www.datadictionary.nhs.uk/) provides standardized definitions, codes, and value sets used across the NHS. CheckTick imports selected datasets to ensure consistency with national healthcare standards.

### Data Quality & Freshness

- **Automated Updates**: Datasets are automatically scraped and synchronized on a regular schedule
